...
@EnableWebSecurity
class SecurityConfig(private val jwtAuthenticationEntryPoint: JwtAuthenticationEntryPoint, private val jwtTokenProvider: JwtTokenProvider, private val userPrincipalDetailService: UserPrincipalDetailService, private val kakaoOAuth2Client: KakaoOAuth2Client, private val testOAuth2Client: TestOAuth2Client, private val facebookOAuth2Client: FacebookOAuth2Client) : WebSecurityConfigurerAdapter() {
